...
import { ArrowRightIcon, WrenchScrewdriverIcon, ClockIcon, ShieldCheckIcon, DevicePhoneMobileIcon } from '@heroicons/react/24/outline';
            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                  <span className="block">Expert Device</span>
                ...
                <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                  ...
                  Our certified technicians are ready to help you with any issue.
                </p>
          ...
          <div className="mt-10">
            <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
              {[
                ...
                {
                  name: 'Quality Parts',
                  description: 'We use only high-quality, original or OEM parts.',
                  icon: ShieldCheckIcon,
                },
                {
                  name: 'All Devices',
                  description: 'We repair smartphones, tablets, laptops, and more.',
      ...
      <footer className="bg-white">
        <div className="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
          ...
          <p className="mt-8 text-center text-base text-gray-400">
            &copy; {new Date().getFullYear()} RepairHub. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
